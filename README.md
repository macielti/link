...
* [`src/link/`](src/link/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/link/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `link` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/link/config.cljs) defaults to `true` in
